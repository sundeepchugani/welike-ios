...
-(void)SaveImageGretast : (NSString *)imagename imagestring : (NSString *)imagestring{
	responseData = [[NSMutableData alloc] init] ;		
	
	NSString *post = [NSString stringWithFormat:@"imagename=%@&imagestring=%@",imagename,imagestring];
    NSData *postData = [post dataUsingEncoding:NSASCIIStringEncoding allowLossyConversion:YES];
    NSString *postLength = [NSString stringWithFormat:@"%d", [postData length]];
    
    NSMutableURLRequest *request = [[NSMutableURLRequest alloc] init];
    [request setURL:[NSURL URLWithString:@"http://www.lookshots.com/basisexpdemo/webservices/saveimagerest.php"]];
...
-(void)AddFriend:(NSString*)friends_id facebook_id:(NSString*)facebook_id {
    
    NSString *post = [NSString stringWithFormat:@"friends[friends_id]=%@&friends[provider]=facebook&friends[facebook_id]=%@",friends_id,facebook_id];
    NSData *postData = [post dataUsingEncoding:NSASCIIStringEncoding allowLossyConversion:YES];
    NSString *postLength = [NSString stringWithFormat:@"%d", [postData length]];
...
-(void)AddFriendEmail:(NSString*)friendsEmail_id userEmail:(NSString*)userEmail{
    
    NSString *post = [NSString stringWithFormat:@"friends[email]=%@&friends[provider]=email&friends[friends_email]=%@",userEmail,friendsEmail_id];
    NSData *postData = [post dataUsingEncoding:NSASCIIStringEncoding allowLossyConversion:YES];
    NSString *postLength = [NSString stringWithFormat:@"%d", [postData length]];
...
-(void)GetEntityByCategory:(NSString*)master_category_id{
    
    //NSString *post = [NSString stringWithFormat:@"entity[master_category_id]=510646adf7e4f33e2c000005",@"510646adf7e4f33e2c000005"];
    NSString *post = [NSString stringWithFormat:@"master_category_id=%@",master_category_id];
    NSData *postData = [post dataUsingEncoding:NSASCIIStringEncoding allowLossyConversion:YES];
...
-(void)saveMedia:(NSString *)entity_name comment:(NSString*)comment address:(NSString*)address lat:(NSString*)lat longitude:(NSString*)longitude master_category_id:(NSString*)master_category_id entity_image:(NSString*)entity_image user_id:(NSString*)user_id user_category_id:(NSString*)user_category_id api_id:(NSString*)api_id rating_count:(NSString*)rating_count group_id:(NSString*)group_id email:(NSString*)email receiver_id:(NSString*)receiver_id{
    
    
    NSString *post = [NSString stringWithFormat:@"api_id=%@&entity_name=%@&comment=%@&address=%@&lat=%@&longitude=%@&master_category_id=%@&entity_image=%@&user_id=%@&user_category_id=%@&rating_count=%@&group_id=%@&email_list=%@&receiver_id=%@",api_id,entity_name,comment,address,lat,longitude,master_category_id,entity_image,user_id,user_category_id,rating_count,group_id,email,receiver_id];
    //NSLog(@"value of **************** %@",post);
...
-(void)getEntityByCategoryID:(NSString *)user_id user_category_id:(NSString*)user_category_id{
...
-(void)weLiike:(NSString*)user_category_id user_id:(NSString*)user_id master_category_id:(NSString*)master_category_id{
    ...
    NSMutableURLRequest *request = [[NSMutableURLRequest alloc] init];
    [request setURL:[NSURL URLWithString:@"http://ec2-54-225-243-66.compute-1.amazonaws.com/user_entity/welike.json"]];
    [request setHTTPMethod:@"POST"];
    [request setValue:postLength forHTTPHeaderField:@"Content-Length"];
    [request setValue:@"application/x-www-form-urlencoded;charset=UTF-8" forHTTPHeaderField:@"Content-Type"];
    [request setHTTPBody:postData];
...
-(void)GetTrends:(NSString*)user_id user_category_id:(NSString*)user_category_id master_category_id:(NSString*)master_category_id{
    ...
    NSMutableURLRequest *request = [[NSMutableURLRequest alloc] init];
    [request setURL:[NSURL URLWithString:@"http://ec2-54-225-243-66.compute-1.amazonaws.com/friends/traids.json"]];
    [request setHTTPMethod:@"POST"];
    [request setValue:postLength forHTTPHeaderField:@"Content-Length"];
    [request setValue:@"application/x-www-form-urlencoded;charset=UTF-8" forHTTPHeaderField:@"Content-Type"];
    [request setHTTPBody:postData];
...
-(void)GetAllFriend:(NSString*)user_id user_category_id:(NSString*)user_category_id master_category_id:(NSString*)master_category_id{
    ...
    NSMutableURLRequest *request = [[NSMutableURLRequest alloc] init];
    [request setURL:[NSURL URLWithString:@"http://ec2-54-225-243-66.compute-1.amazonaws.com/friends/all_friend_for_welike.json"]];
    [request setHTTPMethod:@"POST"];
    [request setValue:postLength forHTTPHeaderField:@"Content-Length"];
    [request setValue:@"application/x-www-form-urlencoded;charset=UTF-8" forHTTPHeaderField:@"Content-Type"];
    [request setHTTPBody:postData];
...
-(void)Repost:(NSString*)user_id post_id:(NSString*)post_id lat:(NSString*)lat longitude:(NSString*)longitude entity_name:(NSString*)entity_name sub_category:(NSString*)sub_category comment:(NSString*)comment rating_count:(NSString*)rating_count address:(NSString*)address user_entity_id :(NSString*)user_entity_id post:(NSString*)post1 receiver_id:(NSString*)receiver_id group_id:(NSString*)group_id{
    ...
    NSString *post = [NSString stringWithFormat:@"user_id=%@&post_id=%@&lat=%@&longitude=%@&entity_name=%@&sub_category=%@&comment=%@&rating_count=%@&address=%@&user_entity_id=%@&post=%@&receiver_id=%@&group_id=%@",user_id,post_id,lat,longitude,entity_name,sub_category,comment,rating_count,address,user_entity_id,post1,receiver_id,group_id];
    NSData *postData = [post dataUsingEncoding:NSASCIIStringEncoding allowLossyConversion:YES];
    //NSData *postData = [post dataUsingEncoding:NSASCIIStringEncoding];
    NSString *postLength = [NSString stringWithFormat:@"%d", [postData length]];
...
-(void)other_user:(NSString*)user_id{
...
-(void)sort_entity:(NSString*)user_id sort_by:(NSString*)sort_by narrow_by_city:(NSString*)narrow_by_city narrow_by_sub_cateogy:(NSString*)narrow_by_sub_cateogy{
    ...
    NSString *post = [NSString stringWithFormat:@"user_id=%@&sort_by=%@&narrow_by_city=%@&narrow_by_sub_cateogy=%@",user_id,sort_by,narrow_by_city,narrow_by_city];
    NSData *postData = [post dataUsingEncoding:NSASCIIStringEncoding allowLossyConversion:YES];
    //NSData *postData = [post dataUsingEncoding:NSASCIIStringEncoding];
    NSString *postLength = [NSString stringWithFormat:@"%d", [postData length]];
...
-(void)soring_setting:(NSString*)user_id{
    ...
    NSMutableURLRequest *request = [[NSMutableURLRequest alloc] init];
    [request setURL:[NSURL URLWithString:@"http://ec2-54-225-243-66.compute-1.amazonaws.com/user_entity/soring_setting.json"]];
    [request setHTTPMethod:@"POST"];
    [request setValue:postLength forHTTPHeaderField:@"Content-Length"];
    [request setValue:@"application/x-www-form-urlencoded;charset=UTF-8" forHTTPHeaderField:@"Content-Type"];
    [request setHTTPBody:postData];
...
-(void)searchEntityForAll:(NSString*)user_id user_category_id:(NSString*)user_category_id search:(NSString*)search master_category_id:(NSString*)master_category_id entity_name:(NSString*)entity_name{
    
    NSString *post = [NSString stringWithFormat:@"user_id=%@&user_category_id=%@&search=%@&master_category_id=%@&entity_name[char]=%@",user_id,user_category_id,search,master_category_id,entity_name];
    NSData *postData = [post dataUsingEncoding:NSASCIIStringEncoding allowLossyConversion:YES];
    //NSData *postData = [post dataUsingEncoding:NSASCIIStringEncoding];
    NSString *postLength = [NSString stringWithFormat:@"%d", [postData length]];
    
    NSMutableURLRequest *request = [[NSMutableURLRequest alloc] init];
    [request setURL:[NSURL URLWithString:@"http://ec2-54-225-243-66.compute-1.amazonaws.com/user_entity/search_all.json"]];
    [request setHTTPMethod:@"POST"];
    [request setValue:postLength forHTTPHeaderField:@"Content-Length"];
    [request setValue:@"application/x-www-form-urlencoded;charset=UTF-8" forHTTPHeaderField:@"Content-Type"];
    [request setHTTPBody:postData];

...
-(NSArray *)subdivided {
	...
	TVLinearBezierCurve *curve1 = [[[TVLinearBezierCurve alloc] initWithStartPoint:p1 endPoint:mid] autorelease];
	TVLinearBezierCurve *curve2 = [[[TVLinearBezierCurve alloc] initWithStartPoint:mid endPoint:p2] autorelease];

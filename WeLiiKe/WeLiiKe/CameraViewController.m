...
@synthesize viewOverlay,libraryPicker,dicForAllMasterCategory;
...
-(void)viewWillAppear:(BOOL)animated{
    NSLog(@"dic = = = = = =%@",dicForAllMasterCategory);
...
- (void)viewDidLoad
{
    ...
    dicForAllMasterCategory = [[NSMutableDictionary alloc]init];
    self.delegate = self;
...
-(void)actionOncapture:(id)sender{
    ...
    if ([[dicForAllMasterCategory valueForKey:@"master_category_name"] isEqualToString:@"Books"] || [[dicForAllMasterCategory valueForKey:@"master_category_name"] isEqualToString:@"Music"] ||[[dicForAllMasterCategory valueForKey:@"master_category_name"] isEqualToString:@"Movies & TV"] ||[[dicForAllMasterCategory valueForKey:@"master_category_name"] isEqualToString:@"Apps & Games"] ) {
    }
}

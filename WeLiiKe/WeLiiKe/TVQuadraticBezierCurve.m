...
-(NSArray *)subdivided {
	...
	TVQuadraticBezierCurve *curve1 = [[[TVQuadraticBezierCurve alloc] initWithStartPoint:p1 controlPoint:ctrl1 endPoint:mid] autorelease];
	TVQuadraticBezierCurve *curve2 = [[[TVQuadraticBezierCurve alloc] initWithStartPoint:mid controlPoint:ctrl2 endPoint:p2] autorelease];

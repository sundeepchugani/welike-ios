//
//  UserProfileFeedViewController.m
//  WeLiiKe
//
...
@implementation UserProfileFeedViewController

@synthesize tableViewForFeed,strForUserId;
...
-(void)callServiceFeed{
    ...
    WeLiikeWebService *service=[[WeLiikeWebService alloc] initWithDelegate:self callback:@selector(user_feedHandler:)];
    ...
    [service user_feed:strForUserId];
        
}


-(void)user_feedHandler:(id)sender{
    ...
    if([sender isKindOfClass:[NSError class]]) {
        ...
        if (error==nil) {
            ...
            if ([strForResponce count]>0) {
                arrayForData=[[NSMutableArray alloc] initWithArray:strForResponce];
